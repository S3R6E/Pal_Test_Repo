...
## other <- rnaturalearth::ne_download(
##   country = "Philippines",
##   type = "populated_places"
## )

  ## geom_text(data = php_cities,  aes(y = latitude, x = longitude + 0.2, label = name), hjust =  0) +


  ## geom_text_repel(data = php_cities,  aes(y = latitude, x = longitude, label = name), nudge_x = 0.5,
  ##   size = 3,
