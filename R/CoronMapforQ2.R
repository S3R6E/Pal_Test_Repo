...
## Siete Picados Marine Protected Area in Coron, Palawan
Coron_Reef <- sf::read_sf("../data/CoronGIS/CORON.shp")

ggplot() + geom_sf(data=Coron_Reef)
...
ggplot() +
  geom_sf(data = coron_reef, aes(fill = "land"), colour = "brown") +
